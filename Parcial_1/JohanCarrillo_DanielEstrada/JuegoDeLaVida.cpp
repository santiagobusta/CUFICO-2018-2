...
{
  int n, k=0; 
  int vivos[3]; // arreglo en el que se almacena el numero de vivos de los tres ultimos ciclos 
  ...
  while(1)
    {
      ...
      if(k == 2){
        // luego de hacer 3 ciclos se evalua si el numero de vivos es estable o no(tres ciclos seguidos tengan el mismo numero de vivos)
        if(vivos[0]==vivos[1] && vivos[1]==vivos[2])
